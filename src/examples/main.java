...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("AAS - LIBMS");
        setPreferredSize(new java.awt.Dimension(805, 507));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(passw, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(33, 33, 33)
...
rs=stat.executeQuery("select * from userdb WHERE username='"+user+"' AND password='"+pass+"'" );
if (rs.next())
       {
           ...
           ob.setVisible(true);
           this.hide();
          // Connected to new JFrameForm Named as "second"
       }
else
       {
